...
<br>
📝Language: <small>The documentation is maintained in English to ensure technical consistency and avoid rework.</small>
...
The project was designed as a structured **end-to-end analytics and machine learning workflow**, not only as isolated notebook experiments.
...
The main idea is to test whether anomaly-related signals can improve supervised model performance when compared with a simpler baseline approach.
...
- prepare train, validation, and test logic
...
This structure keeps the workflow clear, reproducible, and easier to explain in a portfolio context.
...
- cloud deployment
- stronger time-series validation strategy
