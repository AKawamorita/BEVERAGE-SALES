...
class LightGBMRegressorBaseLine:
    ...
    This class trains a LightGBM regression model without anomaly detection features.
    ...
    def save_model(self, filename: str = "lightgbm_baseline_model.joblib") -> Path:
        """
    ...
    def save_best_params(self, filename: str = "lightgbm_baseline_best_params.json") -> Path:
        """
    ...
    def save_metrics(
        ...
        filename: str = "lightgbm_baseline_metrics.json"
    ) -> Path:
        """
